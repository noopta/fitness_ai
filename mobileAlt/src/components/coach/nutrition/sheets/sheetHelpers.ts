...
export function richLogFields(
  ...
  // Gut-health enrichment (gut-health feature)
  plants?: string[];
  ...
  if (Array.isArray(meal.plants)) out.plants = meal.plants;
  if (Array.isArray(meal.fermentedFoods)) out.fermentedFoods = meal.fermentedFoods;
  if (typeof meal.ultraProcessed === 'boolean') out.ultraProcessed = meal.ultraProcessed;
