      ...
      {shareUrl && (
        <>
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.open(`https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent('Check out my Axiom strength analysis!')}`, '_blank')}
          >
            Post to X
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => window.open(`https://wa.me/?text=${encodeURIComponent('Check out my Axiom analysis: ' + shareUrl)}`, '_blank')}
          >
            WhatsApp
          </Button>
        </>
