        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Tell Anakin what's going on</p>
            </div>
          </div>
          {stage !== 'loading' && (
            ...
            {stage === 'loading' && (
              ...
              >
                ...
                <div className="text-center space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">Anakin is reviewing the physiological impact and adjusting your plan</p>
                </div>
