...
function getDayStyle(day: string | undefined) {
...
function getIntensityStyle(intensity: string | undefined): string {
          ...
          >
            <div className="px-5 pb-5 space-y-5">
              ...
              <div className="rounded-xl bg-background/60 border border-border/50 px-4 py-3">
                <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground mb-1.5">Anakin's Rationale</p>
